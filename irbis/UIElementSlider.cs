...
public class UIElementSlider
{
        ...
        Color fillC, Texture2D fillT, Texture2D borderT, Texture2D shieldBarTex, Font font, float drawDepth)
	{
        ...
        border = new RectangleBorder(bounds, borderColor, 0.91f);
    ...
    public void Update(GameTime gameTime, float v)
    {
        
        deltaTime += (float)gameTime.ElapsedGameTime.TotalSeconds;
        if (deltaTime >= overlayAnimationSpeed)
        {
            deltaTime -= overlayAnimationSpeed;
            currentOverlayFrame++;
        }
    ...
    public void Update(GameTime gameTime, bool overlayDraw, float v)
    {
        drawOverlay = overlayDraw;
    ...
    public void Update(GameTime gameTime, Color borderC, Color fillC, float v)
    {
        borderColor = borderC;
        fillColor = fillC;
        deltaTime += (float)gameTime.ElapsedGameTime.TotalSeconds;
